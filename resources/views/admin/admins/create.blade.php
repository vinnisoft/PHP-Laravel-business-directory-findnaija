            ...
            <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        ...
                        {{ Form::open(['url' => route('admins.store'), 'id' => 'addSubAdminForm']) }}
                            <div class="form-row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-4">
                                    <div class="position-relative form-group">
                                        ...
                                        {!! Form::password('password', ['class' => 'form-control', 'placeholder' => 'Enter password', 'autocomplete' => 'new-password']) !!}
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="position-relative form-group">
                            ...
                            <div class="position-relative form-group">
                                {!! Form::checkbox('', 'yes', '', ['id' => "allPermissions"]) !!}
                            ...
                            <div class="row">
                                @foreach ($permissions as $permission)
                                    <div class="col-md-2">
                                        <div class="position-relative form-group">
                                            {!! Form::checkbox('permission[]', $permission->name, '', ['id' => "permission$permission->id", 'class' => 'permission']) !!}
                                            {!! Form::label("permission$permission->id", str_replace('.', ' ', ucfirst($permission->name))) !!}
                                        </div>
                                    </div>
                                @endforeach
                            </div>
                            {!! Form::submit('Add', ['class' => 'mt-2 btn btn-primary', 'id' => 'addSubAdminFormBtn']) !!}
                        {!! Form::close() !!}
                    </div>
                </div>                
            </div>            
    ...
    <script>
        ...
        $("#addSubAdminForm").validate({
            ...
            submitHandler: function(form) {    
                ...
                $('#addSubAdminFormBtn').val('Processing');
                $.ajax({
                    headers: {
