                ...
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        ...
                        {{ Form::open(['url' => route('users.update', $user->id), 'id' => 'updateUserForm']) }}
                            <div class="form-row">
                                ...
                                <div class="col-md-6">
                                    <div class="position-relative form-group">
                                        ...
                                        {!! Form::text('phone_number', $user->phone_number, ['class' => 'form-control', 'placeholder' => 'Enter phone number']) !!}                                        
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="position-relative form-group">
                                        {!! Form::label('dob', 'Date of Birth') !!}
                                        {!! Form::date('dob', date('Y-m-d', strtotime($user->dob)), ['class' => 'form-control', 'placeholder' => 'Enter Date of Birth']) !!}                                        
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="position-relative form-group">
                            ...
                            {!! Form::submit('Update', ['class' => 'mt-2 btn btn-primary', 'id' => 'updateUserFormBtn']) !!}
                        {!! Form::close() !!}
                    </div>
                </div>                
            </div>            
    ...
    <script>
        $("#updateUserForm").validate({
            ...
            submitHandler: function(form) {    
                ...
                $('#updateUserFormBtn').val('Processing');    
                $.ajax({
                    headers: {
                    ...
                    success : function(data){
                        if (data.status == true) {
                            $('#updateUserFormBtn').val('Add'); 
                            toastr.success(data.message);
                            window.location.href = "{{ route('users.index') }}";
                        } else {
                            $('#updateUserFormBtn').val('Update'); 
