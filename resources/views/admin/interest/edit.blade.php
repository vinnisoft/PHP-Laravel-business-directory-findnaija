        ...
        <div class="d-flex justify-content-center">
            <div class="main-card mb-3 card col-6">
                <div class="card-body">
                    ...
                    {{ Form::open(['url' => route('interest.update', $interest->id), 'id' => 'addInterestForm']) }}
                        <div class="form-row">
                            <div class="col-md-12">
                                <div class="position-relative form-group">
                                    {!! Form::label('name', 'Name') !!}
                                    {!! Form::text('name', $interest->name, ['class' => 'form-control', 'placeholder' => 'Enter name']) !!}
                                </div>
                            </div>                                
                        </div>               
                        {!! Form::submit('Update', ['class' => 'mt-2 btn btn-primary', 'id' => 'addInterestFormBtn']) !!}
                    {!! Form::close() !!}
                </div>
            </div>        
        </div>        
        ...
        $("#addInterestForm").validate({
            ...
            submitHandler: function(form) {    
                ...
                $.ajax({
                    ...
                    type : 'PUT',
                    url : "{{ route('interest.update', $interest->id) }}",
