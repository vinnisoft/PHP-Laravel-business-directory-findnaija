                                    ...
                                    <div>
                                        <div style="width: 100%; display: inline-block;">
                                            <div class="position-relative h-100 d-flex justify-content-center align-items-center bg-plum-plate"
                                                tabindex="-1">
                                                <div class="slide-img-bg" style="background-image: url({{ asset('assets/images/bg-logo.png') }})"></div>
                                ...
                                <div class="col-md-6">
                                    <div class="position-relative form-group">
                                        ...
                                        <input id="password" type="password"
                                            ...
                                            required autocomplete="current-password" placeholder="Password here...">
                                        @error('password')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="ml-auto">
                                    @if (Route::has('password.request'))
                                        <a class="btn-lg btn btn-link"
                                            href="{{ route('password.request') }}">{{ __('Recover Password?') }}</a>
                                    @endif
